...
//   bit  1:  ? Enable?
//   bit  2:  Swap DWORDs
#define REG_APE__H2B_CMD          0x0050
...
#define REG_APE__H2B_STATUS       0x0054
...
// Set to the APE 0xA8 ticks field when APE firmware boot completes.
#define REG_APE__BOOT_A8TICKS       APE_REG(0x403C)
